...
def fetch_merged_prs():
    ...
    params = {
        'q': 'is:merged state:closed author:sockheadrps type:pr',
    }
    ...
    if response.status_code == 200:
        ...
        for item in items:
            ...
            if 'sockheadrps' not in repo_url:
...
def update_repo_data_with_merged_prs():
    ...
    for pr in merged_prs:
        ...
        if repo_url:
            ...
            pr['stars'] = 0  # Default to 0 stars if repo_url is not found
    
    # Append merged PRs to repo_data dictionary
    repo_data['merged_prs'] = merged_prs
    
    # Write updated repo_data back to repo_data.json
